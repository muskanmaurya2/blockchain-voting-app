...
Ganache: npm install -g ganache-cli (or Ganache GUI)

MetaMask (Browser Extension)

Installation (Requires 3 Terminals)

1. Terminal 1: Run Blockchain
...
Import the first private key from your Ganache terminal. This account is the Admin.
